<%-- 
    ...
    Created on : 29/10/2019, 09:17:32 PM
    Author     : user
--%>
										...
										<div>
                                                                                    <form action="EditorialControl" method ="post" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="direccion" value="" placeholder="Calle 24"/>
                                                                                            </div>
                                                                                        </div>   
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="sitioweb" value="" placeholder="www."/>
                                                                                            </div>
                                                                                        </div>   
                                                                                        <a href="registroCategoria.jsp"></a>
